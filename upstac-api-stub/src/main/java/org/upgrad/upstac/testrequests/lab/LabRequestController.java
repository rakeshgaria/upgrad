...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester() {
        // Get the current logged in user in a User object, this will be the current logged in tester
        User tester = userLoggedInService.getLoggedInUser();
        // pass the User object to TestRequestQueryService method findByTester to find test requests by tester
